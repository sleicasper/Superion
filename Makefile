...
PROGS       = afl-gcc afl-jsfuzz afl-phpfuzz afl-xmlfuzz afl-vbsfuzz afl-showmap afl-tmin afl-gotcpu afl-analyze
...
clean:
	rm -rf $(PROGS) afl-as as afl-g++ afl-clang afl-clang++ *.o *~ a.out core core.[1-9][0-9]* *.stackdump test .test test-instr .test-instr0 .test-instr1 qemu_mode/qemu-2.10.0.tar.bz2 afl-qemu-trace treemutbuild treemutinstall tree_mutation/dist *.so
